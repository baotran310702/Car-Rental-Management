...
public class Cars {
    ...
    public Cars(String TenLX, String SoCho, String SoLuong, String Gia, String NgoaiGio) {
        this.MaLX="";
        this.TenLX = TenLX;
        this.SoCho = SoCho;
        this.SoLuong = SoLuong;
    ...
    public Cars(String MaLX, String TenLX, String SoCho, String SoLuong, String Gia, String NgoaiGio, BufferedImage ImageNgoai, BufferedImage ImageNoiThat) {
        this.MaLX = MaLX;
        this.TenLX = TenLX;
        this.SoCho = SoCho;
        this.SoLuong = SoLuong;
    ...
    public Cars(String MaLX, String TenLX, String SoCho, String SoLuong, String Gia, String NgoaiGio) {
        this.MaLX = MaLX;
        this.TenLX = TenLX;
        this.SoCho = SoCho;
        this.SoLuong = SoLuong;
    ...
    public Cars(String TenLX, String SoCho, String SoLuong, String Gia, String NgoaiGio, BufferedImage ImageNgoai,BufferedImage ImageNoiThat) {
