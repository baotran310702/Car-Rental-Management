...
//    }
    ...
    public static void UpdateStatusOrder(String MaDX, String Status) {
        ...
        try {
            ...
            System.out.println("Updated DonDatXe");

            CallableStatement stmt = conn.prepareCall("{ call TaoHopDong('" + MaDX + "','" + Objects.User.Instance.getMaND() + "','Tao hop dong thue xe','Truc tiep','Khong co') }");
            stmt.execute();
            System.out.println("Data updated successfully");
