        ...
        try {
            ...
            while (rs.next()) {
                ...
                try {
                    ...
                    Objects.Cars c = new Objects.Cars(MaLX, TenLx, SoCho, SoLuong, Gia, NgoaiGio, NoiThat, Ngoai);
    ...
    public static List<Objects.DonDatXe> getListBlackList() {
        ...
        try {
            ...
            String query = "SELECT d.MaDX, k.MaKH, d.TinhTrang,d.NgayDatXe,d.NgayNhanXe,d.NgayTraXe FROM KHACHHANG k join DONDATXE d on k.MaKH = d.MaKH "
                    + "where TinhTrang = 'CHUA XAC NHAN' AND d.NgayDatXe <TO_DATE('"+dateStr+"', 'DD-MM-YYYY')-2";
...
//                         String DiaChi, String CMND_T, String CMND_S, String SoDT, String NgaySinh) {
    ...
    public static Objects.Cars getCarFromID(String Id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                c = new Objects.Cars(MaLX, TenLx, SoCho, SoLuong, Gia, NgoaiGio, ImgNoiThat, ImgNgoai);
            }
    ...
    public static void SignIn(String username, String password) {
        try {
            ...
            ResultSet rs = st.executeQuery("select mand, role,tennd from nguoidung where TENTK = '" + username + "' and MATKHAU = '" + password + "'");
